...
var sqlite3 = require('sqlite3').verbose();  // Povezava na SQLlite bazo
...
var artists = function(page, artist, details, callback) {
  db.all("SELECT Artist.ArtistId, Name, StarsNo " +
    ...
    "ORDER BY Name LIMIT " +itemsPerPage+" OFFSET ($page - 1) * "+itemsPerPage,       //Prikazi 33 izpisov, izpusti prvih N izpisov
...
//Dodan direction ob loadu
app.get('/', function(request, response) {
      response.redirect('/artists/1');
  });

//Strežnik posluša na portu
